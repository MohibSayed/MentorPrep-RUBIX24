        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'Projects' in resume_text:
                    ...
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Projects📝. It will show your technical skills to the Recruiters.</h4>''',
                        unsafe_allow_html=True)
                    
                if 'Education' in resume_text:
                    resume_score = resume_score + 20
                    st.markdown(
                        '''<h4 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added your Education🎓</h4>''',
                        unsafe_allow_html=True)
                else:
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Education🎓. It will show your educational background to the Recruiters.</h4>''',
                        unsafe_allow_html=True)
                ...
                if 'Experience' in resume_text:
                    ...
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Experience👨‍💻. It will show your working background to the Recruiters.</h4>''',
                        unsafe_allow_html=True)
                    

                st.subheader("**Resume Score**")
                st.text("Your Resume Score is: " + str(resume_score) + "%")

                st.subheader("**Resume Analysis Report**")
                st.text("Your Resume Analysis Report is: " + reco_field)
